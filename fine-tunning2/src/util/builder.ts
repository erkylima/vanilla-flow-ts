...
export function ZoomDrag(divMain: any, subElementSelector: any) {
    const that = this;
    ...
    divMain.addEventListener('mousedown', (e: any) => {
        previousX = e.pageX;
        previousY = e.pageY;
    })

    // when mouse is moved, scrollBy() the mouse movement x,y
    divMain.addEventListener('mousemove', (e: any) => {
    ...
    divMain.addEventListener('wheel', (e: any) => {
        e.preventDefault();
    ...
    divMain.addEventListener('dblclick', (e: any) => {
...
ZoomDrag.prototype = {
    ...
    getNewScrollEvent(e: any, scaleOld: any, scaleNew: any) {
        const pos = {x: e.clientX, y: e.clientY};
        return this.getNewScroll(pos, pos, scaleOld, scaleNew);
    },

    getNewScroll(pos: any, posView: any, scaleOld: any, scaleNew: any) {
    ...
    setMoveEnabled(moveEnabled: any) {
